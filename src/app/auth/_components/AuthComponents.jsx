    ...
    <div className="min-h-screen  flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2 playfair-text">
            Welcome
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 mb-8 bg-gray-100 p-1 rounded-xl solway-text">
              <TabsTrigger
                value="login"
                className="rounded-lg data-[state=active]:bg-primary/5 data-[state=active]:text-primary data-[state=active]:shadow-sm font-medium"
              >
                Login
              </TabsTrigger>
              <TabsTrigger
